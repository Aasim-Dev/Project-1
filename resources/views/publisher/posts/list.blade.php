...
@section('content')
    ...
    <button id="addPost">Add Post from Here</button>
    <div class="overlay">
        <div class = "modal">
            <h2 id="modalTitle">Add your Posts</h2>
                <form id="postForm" method="POST" action="{{route('publisher.post.store')}}">
                    @csrf
                    ...
                    <input type="text" id="host" name="host_url" ><br>
                    @error('host_url')
